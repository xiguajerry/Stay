...
import static me.alpha432.stay.util.graphics.opengl.RenderUtil.itemRender;
...
public class HudComponents extends Module {
    ...
    public static EntityPlayer getClosestEnemy() {
        ...
        for (EntityPlayer player : mc.world.playerEntities) {
            ...
            if (Stay.friendManager.isFriend(player)) continue;
    ...
    private BlockPos traceToBlock(float partialTicks, float yaw) {
        final Vec3d pos = EntityUtils.interpolateEntity(mc.player, partialTicks);
    ...
    private BlockPos traceToBlock(float partialTicks, float yaw, Entity player) {
        final Vec3d pos = EntityUtils.interpolateEntity(player, partialTicks);
        final Vec3d dir = MathUtil.direction(yaw);
        return new BlockPos(pos.x + dir.x, pos.y, pos.z + dir.z);
    }
