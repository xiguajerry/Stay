...
import me.alpha432.stay.event.BlockDestructionEvent;
...
public class Announcer extends Module {
    ...
    public static String walkMessage = "I just moved {blocks} blocks thanks to STAY";
    public static String breakMessage = "I just broke {amount} {name} thanks to STAY";
    public static String eatMessage = "I just ate {amount} {name} thanks to STAY";
