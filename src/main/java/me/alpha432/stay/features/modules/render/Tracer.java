...
import me.alpha432.stay.features.modules.combat.AutoCrystal;
...
public class Tracer
    ...
    public Setting<Float> width = this.register(new Setting<>("Width", Float.valueOf(1.0f), Float.valueOf(0.1f), Float.valueOf(5.0f)));
    ...
    public Tracer() {
        super("Tracers", "Draws lines to other players.", Module.Category.VISUAL, false, false, false);
    }
    ...
    public float[] getColorByDistance(Entity entity) {
        ...
        AutoCrystal autoCrystal = Stay.moduleManager.getModuleByClass(AutoCrystal.class);
