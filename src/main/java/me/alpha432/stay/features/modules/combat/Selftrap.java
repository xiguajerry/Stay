...
public class Selftrap extends Module {
    private final Setting<Integer> blocksPerTick = register(new Setting<>("BlocksPerTick", 8, 1, 20));
    ...
    private final Setting<Integer> disableTime = register(new Setting<>("DisableTime", 200, 50, 300));
    ...
    private boolean check() {
        ...
        if (!EntityUtils.isSafe(Selftrap.mc.player)) {
            offTimer.reset();
            return true;
        }
