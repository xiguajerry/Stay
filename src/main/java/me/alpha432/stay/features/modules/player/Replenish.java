...
public class Replenish extends Module {
    ...
    private final Setting<Integer> gapStack = register(new Setting<>("GapStack", 1, 50, 64));
    private final Setting<Integer> xpStackAt = register(new Setting<>("XPStack", 1, 50, 64));
