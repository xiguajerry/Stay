...
public class Yaw
    ...
    public Setting<Direction> direction = this.register(new Setting<>("Direction", Direction.NORTH, v -> this.byDirection.getValue()));
    public Setting<Integer> yaw = this.register(new Setting<>("Yaw", Integer.valueOf(0), Integer.valueOf(-180), Integer.valueOf(180), v -> this.byDirection.getValue() == false));
