...
public class PingSpoof
    ...
    private final Setting<Integer> delay = this.register(new Setting<>("DelayMS", Integer.valueOf(20), Integer.valueOf(0), Integer.valueOf(1000), v -> this.seconds.getValue() == false));
    private final Setting<Integer> secondDelay = this.register(new Setting<>("DelayS", Integer.valueOf(5), Integer.valueOf(0), Integer.valueOf(30), v -> this.seconds.getValue()));
