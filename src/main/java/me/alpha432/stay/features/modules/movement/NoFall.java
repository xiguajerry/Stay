...
public class NoFall
    ...
    private final Setting<Integer> distance = this.register(new Setting<>("Distance", Integer.valueOf(15), Integer.valueOf(0), Integer.valueOf(50), v -> this.mode.getValue() == Mode.BUCKET));
    private final Setting<Boolean> glide = this.register(new Setting<>("Glide", Boolean.valueOf(false), v -> this.mode.getValue() == Mode.ELYTRA));
    private final Setting<Boolean> silent = this.register(new Setting<>("Silent", Boolean.valueOf(true), v -> this.mode.getValue() == Mode.ELYTRA));
    private final Setting<Boolean> bypass = this.register(new Setting<>("Bypass", Boolean.valueOf(false), v -> this.mode.getValue() == Mode.ELYTRA));
