...
public class BoatFly extends Module {
    public Setting<Double> speed = register(new Setting<>("Speed", 3.0, 1.0, 10.0));
    public Setting<Double> verticalSpeed = register(new Setting<>("VerticalSpeed", 3.0, 1.0, 10.0));
    public Setting<Boolean> noKick = register(new Setting<>("No-Kick", true));
    public Setting<Boolean> packet = register(new Setting<>("Packet", true));
    public Setting<Integer> packets = register(new Setting<>("Packets", Integer.valueOf(3), Integer.valueOf(1), Integer.valueOf(5), v -> packet.getValue()));
    public Setting<Integer> interact = register(new Setting<>("Delay", 2, 1, 20));
