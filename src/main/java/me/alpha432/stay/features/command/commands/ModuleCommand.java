...
import me.alpha432.stay.manager.ConfigManager;
...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : Stay.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module1 : Stay.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = Stay.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = Stay.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
