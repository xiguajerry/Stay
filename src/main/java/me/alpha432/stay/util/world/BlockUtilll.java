...
public class BlockUtilll
    ...
    public static List<BlockPos> getBlockSphere(float breakRange, Class clazz) {
        ...
        positions.addAll(BlockUtilll.getSphere(EntityUtils.getPlayerPos(BlockUtilll.mc.player), breakRange, (int) breakRange, false, true, 0).stream().filter(pos -> clazz.isInstance(BlockUtilll.mc.world.getBlockState(pos).getBlock())).collect(Collectors.toList()));
        return positions;
    }
    ...
    public static List<BlockPos> possiblePlacePositions(float placeRange) {
        NonNullList positions = NonNullList.create();
        positions.addAll(BlockUtilll.getSphere(EntityUtils.getPlayerPos(BlockUtilll.mc.player), placeRange, (int) placeRange, false, true, 0).stream().filter(BlockUtilll::canPlaceCrystal).collect(Collectors.toList()));
        return positions;
    }
    ...
    public static List<BlockPos> possiblePlacePositions(float placeRange, boolean specialEntityCheck, boolean oneDot15) {
        NonNullList positions = NonNullList.create();
        positions.addAll(BlockUtilll.getSphere(EntityUtils.getPlayerPos(BlockUtilll.mc.player), placeRange, (int) placeRange, false, true, 0).stream().filter(pos -> BlockUtilll.canPlaceCrystal(pos, specialEntityCheck, oneDot15)).collect(Collectors.toList()));
        return positions;
    }
