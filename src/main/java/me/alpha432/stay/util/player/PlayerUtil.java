        ...
        while(true) {
            while(true) {
                ...
                do {
                    ...
                    entityPlayer3 = (EntityPlayer)var5.next();
                } while(EntityUtils.basicChecksEntity(entityPlayer3));

                if (entityPlayer == null && mc.player.getDistanceSq(entityPlayer3) <= d) {
                    entityPlayer2 = entityPlayer3;
                } else if (entityPlayer != null && mc.player.getDistanceSq(entityPlayer3) <= d && mc.player.getDistanceSq(entityPlayer3) < mc.player.getDistanceSq(entityPlayer)) {
                    entityPlayer2 = entityPlayer3;
                }
            }
        }
