...
import anonymous.team.eventsystem.Cancellable
...
sealed class RenderEntityEvent(
    ...
    sealed class All(
        ...
        ) : All(entity, x, y, z, yaw, partialTicks, render), IEventPosting by Companion {
    ...
    sealed class Model private constructor(
        ...
        class Pre(entity: Entity, block: () -> Unit) : Model(entity, block), IEventPosting by Companion {
            companion object : EventBus() {
                @JvmStatic
                fun of(
                    entity: Entity,
        ...
        class Post(entity: Entity, block: () -> Unit) : Model(entity, block), IEventPosting by Companion {
            companion object : EventBus() {
                @JvmStatic
                fun of(
                    entity: Entity,
