...
import anonymous.team.eventsystem.utils.threads.EventSystemScope
import anonymous.team.eventsystem.utils.threads.runSafe
import anonymous.team.eventsystem.utils.threads.runSafeSuspend
...
fun <E : Event> concurrentListener(
    ...
    val eventBus = getEventBus(eventClass)
    val listener =
        Listener(owner, eventBus.busID, Int.MAX_VALUE) { EventSystemScope.launch { function.invoke(it as E) } }
